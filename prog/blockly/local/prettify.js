...
(function () {
  ...
  var PYTHON_BUILTIN = ["abs,all,any,ascii,bin,bool,breakpoint,bytearray," +
  ...
  var ALL_BUILTIN = [PYTHON_BUILTIN];
  ...
  /**
   * token style for builtin functions.
   * @const
   */
  var PR_BUILTIN = 'blt';
  ...
  function sourceDecorator(options) {
    ...
    var builtin = ("" + options['builtin']).replace(/^ | $/g, '');
    if (builtin.length) {
      fallthroughStylePatterns.push(
          [PR_BUILTIN,
           new RegExp('^(?:' + builtin.replace(/[\s,]+/g, '|') + ')\\b'),
           null]);
    }

    /*var builtin = options['builtin'];
    if (builtin) {
      fallthroughStylePatterns.push([PR_BUILTIN, builtin]);
    }*/
