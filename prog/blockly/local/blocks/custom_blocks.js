...
Blockly.Blocks['text_comment'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("komentiraj")
        .appendField(new Blockly.FieldTextInput("napiši komentar tukaj..."), "TEXT");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setStyle("text_blocks");
    this.setTooltip("Izpiše komentar kode.");
  }
};
...
Blockly.Python.math_to_number = function(a) {
    var txt = Blockly.Python.valueToCode(a, "TEXT", Blockly.Python.ORDER_NONE);
    return ["int(" + txt + ")", Blockly.Python.ORDER_FUNCTION_CALL]
};

Blockly.JavaScript.text_comment = function(a) {
    var str = a.getFieldValue("TEXT");
    return "// " + str + "\n"
};
...
Blockly.JavaScript.controls_forEach_text = function(block) {
  // For each loop (copied from JavaScript generators file).
...
Blockly.Python.controls_forEach_text = function(block) {
  // For each loop (copied from Python generators file).
